...
#define DEFAULT_MIN_INTENSITY 4000	// do not use peaks below MIN_INTENSITY for calibration
...
#define INTERNAL_CALIBRATION_TARGET 10e-6	// 1.5e-6 discard internal calibrants that do not fit CAL2 better than this */
#define DEFAULT_START_SCAN 1
#define DEFAULT_RT_LOWER 60
